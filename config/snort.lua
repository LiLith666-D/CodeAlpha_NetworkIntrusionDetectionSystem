...
include 'CodeAlpha_NetworkIntrusionDetectionSystem/config/snort_defaults.lua'
...
file_id = { rules_file = 'CodeAlpha_NetworkIntrusionDetectionSystem/rules/file_magic.rules' }
file_policy = { }
...
ips =
{
    ...
    variables = default_variables,
     rules = [[
        include CodeAlpha_NetworkIntrusionDetectionSystem/rules/local.rules
    ]]
}
